    ...
    <div className={cn("grid gap-6", className)} {...props}>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex items-center justify-between">
                  ...
                  <Link href={"/forgot-password"} className={cn(buttonVariants({ variant: "link" }), "h-auto p-0 text-xs font-normal text-muted-foreground")}>Lupa password?</Link>
                </div>
                <FormControl>
                  <InputGroup className="h-11">
                    <InputGroupAddon>
          ...
          />
          <Button className="w-full h-11" type="submit" disabled={isLoading || isSocialLoading}>
